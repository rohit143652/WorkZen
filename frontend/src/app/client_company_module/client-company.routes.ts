...
import { ClientSubscriptionComponent } from '../subscription_module/components/client-subscription/client-subscription.component';
...
export const CLIENT_COMPANY_ROUTES: Routes = [
  ...
  { path: ':id/subscription', component: ClientSubscriptionComponent, data: { permission: 'CLIENT_SUBSCRIPTION_READ' } }
];
